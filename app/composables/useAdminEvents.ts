...
export const useAdminEvents = () =>
  useState<AdminEvent[]>('admin-events', () => [
    ...
    { slug: 'u20-championship', title: 'U20 Youth Championship', venue: 'Hala Vodova', city: 'Brno', day: '12', month: 'Jul', weekday: 'Sun', time: '14:00', status: 'draft', note: { k: 'updatedDaysAgo', n: 2 } },
    { slug: 'beach-open-smichov', title: 'Beach Volleyball Open', venue: 'Smíchovská pláž', city: 'Praha', day: '01', month: 'Aug', weekday: 'Sat', time: '10:00', status: 'draft', note: { k: 'updatedDaysAgo', n: 5 } },
    ...
    { slug: 'legends-night', title: 'Legends Night — Exhibition', venue: 'Tipsport Arena', city: 'Praha', day: '05', month: 'Jun', weekday: 'Fri', time: '20:00', status: 'cancelled', note: { k: 'ticketsRefunded', n: 118 } }
  ])
